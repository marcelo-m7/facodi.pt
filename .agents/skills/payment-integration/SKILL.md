...
description: Integrate payments with SePay (VietQR), Polar, Stripe, Paddle (MoR subscriptions), and Creem.io (licensing). Use for checkout flows, webhook handlers, subscription lifecycle, QR code payments, revenue splits, and multi-provider order orchestration. Trigger examples: integrate Stripe checkout, add Paddle subscriptions, configure Polar webhooks, implement SePay VietQR.
version: 2.2.0
license: MIT
---
