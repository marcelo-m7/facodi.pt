...
const DevelopmentBadge: React.FC<DevelopmentBadgeProps> = ({ label, onClick }) => {
  return (
    <button
      type="button"
      onClick={onClick}
      className="fixed bottom-4 left-4 z-[120] bg-white stark-border px-3 py-2 text-[9px] font-black uppercase tracking-widest text-gray-700 facodi-hover-primary-ink transition-all shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]"
      aria-label={label}
      title={label}
    >
