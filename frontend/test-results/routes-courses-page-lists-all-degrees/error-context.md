...
- Name: routes.spec.ts >> courses page lists all degrees
- Location: tests/e2e/routes.spec.ts:8:1
...
Locator: locator('[data-testid="course-card"]').first().or(getByText('Sem cursos sincronizados do Odoo neste momento.'))
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="course-card"]').first().or(getByText('Sem cursos sincronizados do Odoo neste momento.'))
