...
- Name: routes.spec.ts >> lesson detail renders a video block state
- Location: tests/e2e/routes.spec.ts:36:1
...
Locator: getByText('Nenhum resultado nos nós de dados.')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Nenhum resultado nos nós de dados.')
