...
- Name: routes.spec.ts >> home loads and shows mission statement
- Location: tests/e2e/routes.spec.ts:3:1
...
Locator: getByText('Ensino superior acessível, aberto e comunitário')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Ensino superior acessível, aberto e comunitário')
